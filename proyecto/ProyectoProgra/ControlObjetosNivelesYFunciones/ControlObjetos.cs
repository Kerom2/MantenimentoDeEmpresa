...
namespace ProyectoCreditos.ControlObjetosNivelesYFunciones
{
    class ControlObjetos
    {
        ...
        //Bloquear objetos en Form Registrar Niveles
        public void bloquearobjetosfuncionnivel(TextBox textbox1, TextBox textbox2, TextBox textbox3
            , Button boton1)
        {
            textbox1.Enabled = false;
            textbox2.Enabled = false;
        ...
        public void bloquearobjetosFunciones(TextBox textbox1, TextBox textbox2
          , Button boton1, Button boton2)
        {
            textbox1.Enabled = true;
            textbox2.Enabled = false;
        ...
        //Desbloquear objetos en Form Registrar Niveles
        public void desbloquearobjetosFunciones(TextBox textbox1, TextBox textbox2
            , Button boton1, Button boton2)
        {
            textbox1.Enabled = false;
            textbox2.Enabled = true;
