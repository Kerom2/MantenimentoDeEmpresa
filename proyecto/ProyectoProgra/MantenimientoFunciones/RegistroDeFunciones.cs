...
{
    public partial class RegistroDeFunciones : Form
    {
        ...
        public RegistroDeFunciones()
        {
            InitializeComponent();
            mo.bloquearobjetosFunciones(textBox1, textBox2, button1, button2);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    RegistroDeFunciones m = new RegistroDeFunciones();
                    m.Show(); this.Hide();
                }
            }
        }
        ...
        {
            RegistroDeFunciones r = new RegistroDeFunciones();
            ...
            else
            {
                ...
                mn.oDataAdapter.InsertCommand.Parameters["@codFun"].Value =
                    this.textBox1.Text;
                mn.oDataAdapter.InsertCommand.Parameters["@nomFun"].Value =
                    this.textBox2.Text;
        ...
        //clic combo de funciones
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            textBox1.Text = mn.devuelvecodigofuncion(Convert.ToString(comboBox1.SelectedItem));
        }
